...
(function(t) {
    ...
    function s(n, r) {
        ...
        function p(e) {
            ye++,
            ce && (Q("viewDestroy", ce, ce, ce.element), N(), ce.triggerEventDestroy(), $(), ce.element.remove(), oe.deactivateButton(ce.name)),
            oe.activateButton(e),
        ...
        function m(t) {
            ye++,
            ce.start && (Q("viewDestroy", ce, ce, ce.element), N(), x()),
            $(),
    ...
    function c(e) {
        ...
        function a(e, n) {
            ...
            function(r) {
                ...
                if (n == H) {
                    if (r) for (a = 0; r.length > a; a++) o = r[a],
                    i || (o = D(o, e)),
                    o && O.push(o);
                    F--,
                    F || M(O)
        ...
        function s(e) {
            ...
            e), "string" == typeof n.className && (n.className = n.className.split(/\s+/))), n) {
                for (t.isArray(n.events) && (n.events = t.map(n.events,
                function(t) {
                    return D(t, n)
        ...
        function m(e) {
            return t.isFunction(e) ? t.grep(O, e) : null != e ? (e += "", t.grep(O,
            function(t) {
                return t._id == e
            })) : O
        }
        ...
        function b() {--A || k("loading", null, !1, x())
        }
        function D(n, r) {
            var a, o, i, s, l = {};
    ...
    function O(n, r, a) {
        ...
        return e.isMoment(c) ? (l = e.apply(null, n), c._ambigTime && (l._ambigTime = !0), c._ambigZone && (l._ambigZone = !0)) : h(c) || void 0 === c ? l = e.apply(null, n) : (o = !1, i = !1, d ? Ne.test(c) ? (c += "-01", n = [c], o = !0, i = !0) : (s = Ye.exec(c)) && (o = !s[5], i = !0) : t.isArray(c) && (i = !0), l = r ? e.utc.apply(e, n) : e.apply(null, n), o ? (l._ambigTime = !0, l._ambigZone = !0) : a && (i ? l._ambigZone = !0 : d && l.zone(c))),
        new W(l)
    }
    function W(t) {
        f(this, t)
    ...
    function J(e, n, r) {
        ...
        function c() {
            ...
            r += "<th class='fc-day-header fc-" + Ae[e.day()] + " " + n + "'>" + R(he(e, ae)) + "</th>";
            return r += "</tr></thead>"
        }
        function d() {
        ...
        function v(t) {
            ...
            ne.clear(),
            X = 0,
            oe && (X = Y.find("th.fc-week-number").outerWidth()),
            V = Math.floor((q - X) / G),
            g(O.slice(0, -1), V)
        }
        function h(t) {
        ...
        A.setHeight = f,
        A.setWidth = v,
        A.renderDayOverlay = m,
        A.defaultSelectionEnd = b,
        A.renderSelection = D,
        A.clearSelection = w,
        A.reportDayClick = C,
        A.dragStart = E,
    ...
    function ae(n, r, a) {
        ...
        function d() {
            ...
            a = "";
            for (a += "<thead><tr>", Le("weekNumbers") ? (t = Ve(0, 0), e = Qe(t), Ne ? e += Le("weekNumberTitle") : e = Le("weekNumberTitle") + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + R(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; xe > n; n++) t = Ve(0, n),
            a += "<th class='fc-" + Ae[t.day()] + " fc-col" + n + " " + r + "'>" + R(Ge(t, We)) + "</th>";
        ...
        function A(t) {
            ...
            a >= 0 && (n.time(e.duration(Ye + a * be)), n = r.rezoneDate(n)),
            n
        }
        function N(t, n) {
        ...
        function D(t, e) {
            ...
            e.draggable({
                ...
                stop: function(o, i) {
                    ...
                    n ? N(e[0], t, r, o, i) : (e.css("filter", ""), _(t, e))
                }
            })
        }
        function w(e, r, a) {
