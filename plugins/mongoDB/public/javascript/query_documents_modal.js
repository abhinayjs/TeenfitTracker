           ...
           return;
            ...
            for(var i = 1; i < docInfoKeys.length; i++){
              ...
              if($('#' + fieldKey + "_input").val() != ""){
                ...
                // var inputVal = $('#' + fieldKey + "_input").val();
                // alert(inputVal);
                // queryBox[fieldKey] = new RegExp("^.*" + inputVal + ".*$");      
                // alert(queryBox[fieldKey]);
                queryBox[fieldKey] = $('#' + fieldKey + "_input").val();  
              }
            ...
            // postData["queryBox"] = queryBox;

            // postData["queryBox"] = postData["queryBox"].replace(/\"/g, "");
           
            // alert(postData["queryBox"]["name"]);
