...
//         };
//         $('#base-panel').empty();
//         var baseDiv = document.getElementById('base-panel');
//         var divP = document.createElement('div');
//         divP.id = "panel";
//         var divPH = document.createElement('div');
//         divPH.id = "panel-heading"
//         var divPHTitle = document.createElement('div');
//         divPHTitle.id = "panel-title";
//         divPHTitle.innerHTML = "<h4>Statistics: "+dbname+"</h>";
//         divPH.appendChild(divPHTitle);
//         divP.appendChild(divPH);
//         baseDiv.appendChild(divP);
//         // var divPH = document.getElementById('panel-heading');
//         // $('#panel-heading').empty();
//         // var divPHTitle = document.createElement('div');
//         // divPHTitle.id = "panel-title";
//         // divPHTitle.innerHTML = "<h4>Statistics: "+dbname+"</h>";
