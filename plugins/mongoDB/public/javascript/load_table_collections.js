...
//             if(collection.data[j].name != 'system.indexes'){
//                 $('#collection').append(
//                 "<li> <a  a_collection_id = '"+collection.data[j].name+"''><i class='fa fa-table fa-fw'></i>"+collection.data[j].name+"<span class='fa arrow' id='"+collection.data[j].name+"' ></span></a> "+
//                     // "<div >"+
//                          "<ul class='nav nav-third-level' id='"+collection.data[j].name+"_collection'   style='display: none'>"+
//                             "<li ><a href='#' data-toggle='modal' data-target='#myModal' ><span>Create Document</span></a>"+
//                             "</li>"+
//                             "<li ><a href='logout.php?action=0'><span>Delete Collection</span></a>"+
//                             "</li>"+
//                         "</ul>"+
//                      //"</div>"+
//                 "</li>"
...
//                     $("#queryDocuments_dbname").val(databaseName);
//                     loadDocInfo(databaseName,collectionName);
//                     // alert($("#queryDocuments_dbname").val()+" : "+$("#queryDocuments_collecname").val())
//                 }
//         });//end click function  
